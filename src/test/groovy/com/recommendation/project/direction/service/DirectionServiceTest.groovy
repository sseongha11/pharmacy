package com.recommendation.project.direction.service
...
class DirectionServiceTest extends Specification {
    ...
    // Mocking the PharmacySearchService
    private PharmacySearchService pharmacySearchService = Mock()

    // Creating an instance of DirectionService
    ...
    def "buildDirectionList - should return a sorted list of directions based on the distance"() {
        given:
    ...
    def "buildDirectionList - should return a list of pharmacies within 10km radius"() {
        given:
        pharmacyList.add(
                PharmacyDto.builder()
                        .id(3L)
